...
class AbsencesList extends StatelessWidget {
  ...
  //                       style: TextStyle(fontSize: 14),
  //                     ),
  //                     (absence.memberNote != null && absence.memberNote!.isNotEmpty)?
  //                       Text(
  //                         'Member\'s Note: ${absence.memberNote}',
  //                         style: TextStyle(fontSize: 14),
  //                       ): SizedBox.shrink(),
  //                     (absence.admitterNote != null && absence.admitterNote!.isNotEmpty)?
  //                       Text(
  ...
  String _formatDate(String? dateString) {
    if (dateString == null || dateString.isEmpty) {
      return "Unknown"; // Fallback for null or empty date
    }
    ...
    try {
      ...
      return "Invalid Date"; // Fallback text for invalid format
    }
  }
  ...
  /// ✅ **Improved UI for AbsencesEmpty State**
